      ...
      {user?.isVerified === false && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
              <Card className="bg-red-50 border border-red-300 text-red-800 p-6 rounded-xl shadow-lg max-w-md w-full text-center">
                ...
                <p className="text-sm">
                  Para poder acceder a los servicios, primero debes completar
                ...
                <Button variant={"outline"} className="text-hero-orange  border-hero-orange" asChild >
                  <Link 
                  href={itemsNavs.editarPerfil.href}>
                    Completar Perfil
                  </Link>
